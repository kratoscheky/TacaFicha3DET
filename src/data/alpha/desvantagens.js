export const Desvantagens = [
  ...
  },
  {
    ...
    Descricao: `Você segue um código rígido que o impede de fazer (ou deixar de fazer) alguma coisa.
    Sempre que você viola um Código, recebe –1 Ponto de Experiência no final da aventura.
    Cada violação vale –1 PE. Você pode ter até quatro Códigos de Honra, no valor total de –4 pontos (e será alguém muuuito honrado e bonzinho...).`,
    Pontos: -1,
    Tipo: [
      {
        Nome: "1ª Lei de Asimov",
        Descricao: `jamais causar mal a um ser humano ou, por omissão, permitir que um ser humano sofra qualquer mal.`,
        Pontos: -1
      },
      {
        Nome: "2ª Lei de Asimov",
        Descricao: `Sempre obedecer ordens de seres humanos, exceto quando essas ordens violam qualquer outro Código que você possua.`,
        Pontos: -1
      },
      {
        Nome: "Código de Arena",
        Descricao: `Nunca lutar em certos tipos de terreno; escolha dois terrenos (veja a vantagem Arena).`,
        Pontos: -1
      },
      {
        Nome: "Código do Caçador",
        Descricao: `Nunca matar (combater ou capturar, quando necessário, mas nunca matar) filhotes ou fêmeas grávidas de qualquer espécie. Nunca abandonar uma caça abatida. Sempre escolher como oponente a criatura de aparência mais perigosa que esteja à vista.`,
        Pontos: -1
      },
      {
        Nome: "Código do Cavalheiro",
        Descricao: `Nunca atacar uma mulher (ou fêmea de qualquer espécie), nem mesmo quando atacado, e nem permitir que seus companheiros o façam. Sempre atender um pedido de ajuda de uma mulher.`,
        Pontos: -1
      },
      {
        Nome: "Código do Combate",
        Descricao: `Nunca atacar um oponente indefeso, ou em desvantagem numérica.`,
        Pontos: -1
      },
      {
        Nome: "Código da Derrota",
        Descricao: `Nunca se permitir ser capturado com vida e nunca aceitar a derrota. Caso seja reduzido a 0 Pontos de Vida (apenas em situações de combate honrado, um contra um) ou capturado (em qualquer situação), você deve tirar a própria vida. (Nem que seja para ressuscitar mais tarde...)`,
        Pontos: -1
      },
      {
        Nome: "Código da Gratidão",
        Descricao: `Quando alguém salva sua vida (ou de um ente querido seu), você fica a serviço dessa pessoa, até conseguir devolver o favor (salvar sua vida).`,
        Pontos: -1
      },
      {
        Nome: "Código dos Heróis",
        Descricao: `Sempre cumprir sua palavra,
      ...
      },
      {
        ...
        Descricao: `Nunca roubar, trapacear, mentir ou desobedecer as leis locais, nem permitir que seus companheiros o façam.`,
        Pontos: -1
      },
      {
        Nome: "Código da Redenção",
        Descricao: `Jamais atacar sem provocação, sempre aceitar um pedido de rendição, sempre poupar oponentes reduzidos a 0 Pontos de Vida.`,
        Pontos: -1
      }
    ]
  },
  ...
  },
  {
    ...
    Tipo: [
      {
        Nome: "Cleptomaníaco",
        Descricao: `você rouba coisas de que não precisa, não por seu valor, apenas por serem interessantes. Sempre que surgir a chance de roubar algo, deve ser bem-sucedido em um teste de R para evitar. Um cleptomaníaco nunca devolve para os donos o produto de seus roubos, e lutará para evitar que isso aconteça.`,
        Pontos: -1
      },
      {
        Nome: "Compulsivo",
      ...
      {
        Nome: "Demente",
        Descricao: `sua inteligência e capacidade de aprendizado são reduzidas. Em regras, é o mesmo que ser Inculto: você não sabe ler ou escrever, nem se comunicar com outras pessoas.`,
        Pontos: -1
      },
      {
        Nome: "Depressivo",
        Descricao: `você pode perder subitamente a motivação de viver, algo perigoso quando acontece em combate! Em regras, é o mesmo que Assombrado.`,
        Pontos: -2
      },
      {
        Nome: "Dupla Personalidade",
        Descricao: `é parecido com Forma Alternativa: você tem um outro personagem feito com a mesma quantidade de pontos, mas com outras características, vantagens, desvantagens, Perícias e magias conhecidas. Sim, esta Dupla Personalidade é mesmo meio exagerada — porque sua própria aparência e poderes também mudam! No entanto, a mudança não está sob seu controle. A cada hora, ou em qualquer situação de perigo, o mestre rola um dado; um resultado 4, 5 ou 6 indica que você mudou para sua outra personalidade. Uma personalidade não se lembra do que a outra fez. Na verdade, às vezes você nem acredita que tem esse problema!`,
        Pontos: 0
      },
      {
        Nome: "Distraído",
        Descricao: `você tem dificuldade para se concentrar em alguma coisa na qual não está interessado (qualquer coisa não ligada a uma Devoção, Dependência, Código de Honra...). Você sofre uma penalidade extra de –1 (cumulativo com quaisquer outros) em qualquer teste envolvendo algo que você não deseja muito fazer.`,
        Pontos: 0
      },
      {
        Nome: "Fantasia",
        Descricao: `você acredita ser alguém ou alguma coisa que não é, ou acha que pode fazer alguma coisa de que não é capaz. (Eu sou um mago! Eu posso voar! Eu sou o Mestre Arsenal!) Você fala de si mesmo o tempo todo para anunciar sua fantasia para todos à volta.`,
        Pontos: -1
      },
      {
        Nome: "Fobia",
      ...
      {
        Nome: "Fúria",
        Descricao: `igual à desvantagem.`,
        Pontos: -1
      },
      {
        Nome: "Histérico",
        Descricao: `você pode começar a rir ou chorar sem motivo. Em regras, é o mesmo que Assombrado.`,
        Pontos: -2
      },
      {
        Nome: "Homicida",
        Descricao: `precisa matar um humano, semi-humano ou humanoide a cada 1d dias. Se não cometer um assassinato quando o prazo se esgotar, deve fazer um teste de Resistência por hora; uma falha significa que vai tentar atacar e matar a primeira pessoa que encontrar. (Precisa dizer que esta desvantagem não é recomendada   para personagens jogadores?)`,
        Pontos: -2
      },
      {
        Nome: "Megalomaníaco",
        Descricao: `você acredita ser   invencível, imortal, alguém destinado a realizar um grande   objetivo — e acha que ninguém jamais conseguirá detê-lo!   Você com freqüência ignora perigos que poderiam matá-lo.   Nunca recusa um desafio, nunca se rende, nunca foge e   sempre luta até a morte.`,
        Pontos: -1
      },
      {
        Nome: "Mentiroso",
        Descricao: `você nunca diz a verdade   sobre coisa alguma, mesmo quando quer. Com um teste de   Resistência pode vencer momentaneamente sua insanidade   e dizer algo verdadeiro para seus amigos. O mestre faz esse   teste em segredo, para que os jogadores não sabiam se   podem confiar no colega.`,
        Pontos: -1
      },
      {
        Nome: "Obsessivo",
        Descricao: `igual a Devoção.`,
        Pontos: -1
      },
      {
        Nome: "Paranoico",
      ...
      {
        Nome: "Sonâmbulo",
        Descricao: `cada vez que dormir, role   um dado: um resultado 4, 5 ou 6 indica que você começa   a andar enquanto dorme. Você não pode lutar, mas acorda   se sofrer qualquer dano.`,
        Pontos: 0
      },
      {
        Nome: "Suicida",
        Descricao: `você não dá valor à própria vida.   Embora não tenha coragem para se matar, sempre procura   oportunidades de morrer — desafiando inimigos poderosos,   correndo riscos desnecessários, fazendo coisas de forma   impensada. Você pode ser Suicida e Imortal (mas não vai   ganhar muitos Pontos de Experiência, uma vez que não recebe   nenhum ponto em aventuras durante as quais tenha morrido).`,
        Pontos: 0
      }
    ]
  },
  ...
  {
    Nome: "Interferência Mágica",
    Descricao: `Você emana uma aura de “anti má gica” que dificulta o uso de magia nas proximidades. Sempre que uma magia é lançada a até 10m de você, o mestre rola secretamente um dado: com um resultado 1 ou 2, a magia falha, mas gasta os PMs necessários normalmente. Qualquer conjurador de magias sente um mal-estar momentâneo quando você está perto, sendo capaz de perceber imediatamente sua interferência. Um conjurador pode gastar 1 PM extra para ignorar a chance de falha e lançar sua magia normalmente na área afetada.`,
    Pontos: 0
  },
  {
    Nome: "Má Fama",
  ...
  {
    Nome: "Maldição",
    Descricao: `Você foi vítima de uma maldição que o perturba todos os dias. Nada que você possa fazer vai acabar com essa sina; sempre ela voltará de alguma maneira. A Maldição pode ser inventada pelo jogador, mas sua natureza e efeito exatos serão decididos pelo mestre.
    ...
    Tipo: [
      {
        Nome: "Maldição Suave",
        Descricao: `mais irritante ou constrangedora que qualquer outra coisa, esta Maldição traz problemas, mas nunca provoca nenhuma penalidade. Por exemplo, pode ser que você se transforme em mulher quando molhado com água fria, e depois volte ao normal quando molhado com água quente.`,
        Pontos: -1
      },
      {
        Nome: "Maldição Grave",
        Descricao: `algo que coloca sua vida em risco. Se você se transforma em gatinho, porquinho ou pato quando é molhado com água fria (e com 0 em todas as características, menos uma, enquanto está nessa forma...), isso acaba sendo um grande problema!`,
        Pontos: -2
      }
    ]
  },
  {
    Nome: "Modelo Especial",
  ...
  },
  {
    ...
    Tipo: [
      {
        Nome: "Agradável",
        Descricao: `sua magia vem acompanhada de música empolgante e ilusões visuais agradáveis, como chuvas de pétalas, revoadas de pássaros, explosões coloridas, a bandeira de sua nação, ou quaisquer outras imagens positivas. É tudo tão bonito, que dificilmente faria mal a alguém! Seus adversários recebem bem merecidos A+1 e R+1 para resistir às suas magias e ataques.`,
        Pontos: -1
      },
      {
        Nome: "Constrangedor",
        Descricao: `sua magia requer atos vergonhosos. Você precisa dizer coisas embaraçosas (“Eu invoco o Poder Floral da Tia Gertrudes!”) e realizar coreografias humilhantes. Para aventureiras bonitas, isso normalmente envolve uma dança e efeitos mágicos que revelam sua nudez. Como resultado, suas magias e poderes têm Força de Ataque –1.`,
        Pontos: -1
      },
      {
        Nome: "Exagerado",
  ...
  {
    Nome: "Poder Vingativo",
    Descricao: `Às vezes, invocar um poder sobrenatural pode cobrar um preço em sofrimento. Sempre que você lança uma magia ou usa qualquer vantagem que consome Pontos de Magia, sofre 1 ponto de dano (sem direito a testes para resistir). Exceto por esse fato, a vantagem ou magia funciona normalmente.`,
    Pontos: -1
  },
  {
    Nome: "Ponto Fraco",
  ...
  {
    Nome: "Restrição de Poder",
    Descricao: `É mais difícil para você usar seus poderes em certas condições, escolhidas com aprovação do mestre. Quando essa condição está presente, você precisa gastar duas vezes mais PMs para lançar magias e usar vantagens. O custo da desvantagem depende de quão comum são essas condições.
    ...
    Tipo: [
      {
        Nome: "Incomum",
        Descricao: `esta condição não acontece todo dia, mas você vai enfrentá-la em pelo menos 25% do tempo. Digamos, quando você estiver molhado; durante uma das fases da lua; durante uma das estações do ano; contra mamíferos, répteis, goblinoides, mortos-vivos ou outra grande família de criaturas; sobre você mesmo...`,
        Pontos: -1
      },
      {
        Nome: "Comum",
        Descricao: `você vai enfrentar esta condição quase todos os dias, ou em pelo menos 50% do tempo: à noite ou à luz do dia; contra todos os animais, todos os youkai (incluindo mortos-vivos) ou todos os humanoides.`,
        Pontos: -2
      },
      {
        Nome: "Muito Comum",
        Descricao: `esta condição acontece quase o tempo todo. Por exemplo, sua mágica não funciona se alguém estiver olhando (incluindo inimigos!); não funciona contra nenhuma criatura viva, ou contra nenhum objeto inanimado. Em alguns casos (como estações do ano ou fases da lua) o mestre pode rolar os dados para saber a possibilidade do evento acontecer, ou apenas decidir em segredo.`,
        Pontos: -3
      }
    ]
  },
