export const Vantagens = [
  {
    Nome: "Aceleração",
    Descricao: `Você corre mais rápido. Esta vantagem acrescenta 1
    ...
    Você pode executar sua ação e movimentos em
    qualquer ordem. Pode mover-se, agir e mover-se de novo;
    mover-se duas vezes e agir; ou agir e mover-se duas vezes.
    Usar esta vantagem em situações de combate gasta
    1 Ponto de Magia. Os efeitos duram até o fim do combate`,
    Pontos: 1
  },
  {
    Nome: "Adaptador",
    Descricao: `Você tem facilidade para lidar com armas, aprender
    novas técnicas e improvisar novos golpes. Esta vantagem
    permite mudar o tipo de dano de sua Força ou Poder de Fogo
    sem sofrer nenhuma penalidade, como se fosse seu próprio
    dano inicial. Para mais detalhes veja o capítulo “Combate”.`,
    Pontos: 1
  },
  {
    Nome: "Aliado",
    Descricao: `Você tem um companheiro com quem pode contar.
    Pode ser uma pessoa, animal ou mecha, à sua escolha.
    O Aliado é um NPC que você controla, mas o mestre
    pode às vezes interferir nesse controle — por exemplo,
    quando acreditar que o Aliado faria ou não faria algo. Seu
    Aliado ajuda você, mas muitas vezes ele também pode
    ...
    aumenta proporcionalmente. Você não ganha PEs por
    vitórias de seu Aliado.`,
    Pontos: 1
  },
  {
    Nome: "Alquimista",
    Descricao: `Você sabe traçar diagramas arcanos que potencializam
    ...
    falha. Se tiver sucesso, na rodada seguinte você pode
    usar uma magia ou vantagem gastando metade dos PMs
    necessários (arredonde para cima).
    Você pode desenhar com qualquer material, sobre
    qualquer superfície lisa (chão, parede...). Você deve anunciar
  ...
  },
  {
    ...
    Descricao: `Por algum motivo você não parece perigoso. Talvez
    pareça pequeno, fraco ou covarde. Talvez seja um bichinho
    fofo, um vovô barrigudo, uma menininha segurando pirulito...
    você escolhe o motivo.
    Além de outros benefícios, como entrar em lugares
    protegidos sem levantar suspeitas, possuir uma Aparência
    Inofensiva também ajuda em combate. Ela vai surpreender
    seu oponente — você ganha uma ação extra antes do
    primeiro turno de um combate. Esse truque não funciona
    com ninguém que já tenha visto você lutar, e também não
  ...
  {
    Nome: "Arcano",
    Descricao: `Esta vantagem diz que você tem uma poderosa aptidão
    natural para a magia, e pode ser um grande mago mais
    facilmente. Você pode utilizar Magia Branca, Magia Elemental
    e Magia Negra como se tivesse comprado todas as três vantagens.
    Confira mais detalhes no capítulo “Magos e Magia”.`,
    Pontos: 4
  },
  {
    Nome: "Área de Batalha",
    Descricao: `Você tem o poder de transportar a si mesmo e uma
    ou mais criaturas (oponentes e/ou aliados) temporariamente
    para outra dimensão, onde você leva vantagem em combate.
    ...
    Você não pode transportar um oponente contra a
    vontade se ele tiver Resistência superior à sua Habilidade.
    No entanto, note que um oponente poderoso pode permitir
    ser transportado (talvez para afastar você de seus aliados).
    Ativar a Área de Batalha custa 2 PMs. Mantê-la custa
    2 PMs por turno, e você pode mantê-la por um número
    máximo de turnos igual à sua Habilidade.
    A Área pode ter um destes três efeitos, que você
    escolhe no momento do uso:
    • Habilidade +1, Armadura +2. Além disso, você
    ...
    quando ela termina. Caso você seja derrotado, a Área desaparece.
  ...
  {
    Nome: "Arena",
    Descricao: `Você tem sua própria arena de lutas, ou sabe lutar
    melhor em certo tipo de terreno ou condição. Você ganha
    H+2 quando está em sua Arena, apenas em situações de
    combate. Vale lembrar que, quando alguém faz um desafio
  ...
  {
    Nome: "Armadura Extra",
    Descricao: `Você é mais resistente a certos tipos de dano. Sua Armadura
    ...
    corporais).
    • Poder de Fogo. Qualquer dano causado com PdF
    (ataques à distância).
    • Magia. Qualquer dano causado por magia, incluindo
    armas mágicas (mas não incluindo outros ataques ou
    manobras que gastam PMs).
    ...
    Benefícios são cumulativos. Se você tem Armadura
    Extra: Magia e Fogo, e recebe um ataque mágico da Escola
  ...
  },
  {
    ...
    Descricao: `Praticamente qualquer aventureiro, herói ou guerreiro
    tem algum tipo de técnica ou ataque que provoca dano maior.
    Isso é tão comum nos mundos de aventura que qualquer
    personagem pode fazer um Ataque Especial gastando 1 PM
    e ganhando F+1 ou PdF+1. Isto é apenas uma manobra
    especial; não é preciso pagar pontos de personagem por ela.
    A vantagem Ataque Especial, no entanto, é uma versão
    melhorada dessa manobra. Ela permite gastar 1 PM e
    aumentar em +2 sua Força ou Poder de Fogo (escolha F ou
    PdF quando adquirir esta vantagem) para um único ataque.
    Você pode pagar mais ou menos pela vantagem,
    para dar mais poderes ou fraquezas ao Ataque Especial.
    Alguns desses ajustes também afetam o custo do ataque
    em Pontos de Magia.
    Um Ataque Especial nunca pode custar menos de 1
    ponto de personagem. Também não pode custar menos de
    1 PM para ser usado.
    ...
    Tipo: [
      {
        Nome: "Amplo",
        Descricao: `(+2 pontos, +2 PMs): apenas para ataques
        com PdF. Se você quiser, todas as criaturas no alcance do
        ataque à distância são atingidas (incluindo aliados, e até
        mesmo você!). Todos os alvos têm direito a esquiva. Você
        pode ignorar um número de alvos igual ao seu PdF.`,
        Pontos: 2
      },
      {
        Nome: "Lento",
        Descricao: `(–1 ponto): apenas para ataques com PdF. O
        alvo recebe H+2 em sua esquiva.`,
        Pontos: 1
      },
      {
        Nome: "Paralisante",
        Descricao: `(+1 ponto, +1 PM): além de causar
        dano, o ataque funciona como a vantagem Paralisia (pelo
        custo normal em Pontos de Magia).`,
        Pontos: 1
      },
      {
        Nome: "Penetrante",
        Descricao: `(+1 ponto, +1 PM): impõe A–2 contra
        o alvo em sua Força de Defesa.`,
        Pontos: 1
      },
      {
        Nome: "Perigoso",
        Descricao: `(+1 pontos, +1 PMs): este ataque consegue
        um acerto crítico com um resultado 5 ou 6 no dado.`,
        Pontos: 1
      },
      {
        Nome: "Perto da Morte",
        Descricao: `(–2 pontos, –1 PM): o ataque só
        pode ser usado quando você está Perto da Morte.`,
        Pontos: 1
      },
      {
        Nome: "Poderoso",
        Descricao: `(+1 pontos, +1 PMs): em caso de acerto
        crítico, o ataque triplica sua Força ou PdF (em vez de duplicar).`,
        Pontos: 1
      },
      {
        Nome: "Preciso",
        Descricao: `impõe H–2 contra o alvo em
        sua Força de Defesa.`,
        Pontos: 1
      },
      {
        Nome: "Teleguiado",
        Descricao: `apenas para PdF. O ataque
        persegue o alvo, impondo H–2 em tentativas de esquiva.`,
        Pontos: 1
      }
    ]
  },
  {
    ...
    Descricao: `Você pode fazer mais ataques com Força em uma
    única rodada. Cada golpe (incluindo o primeiro) gasta 1 PM.
    Assim, atacar três vezes na mesma rodada gasta 3 PMs. O
    número máximo de ataques que você pode fazer por rodada
    é igual à sua Habilidade.
  ...
  {
    Nome: "Boa Fama",
    Descricao: `Você é respeitado entre outros heróis e aventureiros,
    e também entre boa parte das pessoas comuns. Pode ser
    ...
    despercebido ou agir disfarçado. Se você tem um Ponto
    Fraco (veja mais adiante), ele será conhecido por todos.`,
    Pontos: 1
  },
  {
    Nome: "Clericato",
    Descricao: `Você é um sacerdote, druida ou xamã, e serve a uma
  ...
  {
    Nome: "Deflexão",
    Descricao: `Você tem chance de desviar completamente um ataque
    feito com Poder de Fogo, sem sofrer quase nenhum
    dano. Com esta vantagem, você pode gastar 2 PMs e
    duplicar sua Habilidade para calcular a Força de Defesa
    contra um único ataque.
    A Deflexão é uma esquiva — ou seja, você só pode
    usá-la um número máximo de vezes por rodada igual à sua H.`,
    Pontos: 1
  },
  {
    Nome: "Elementalista",
    Descricao: `Escolha um tipo de Magia Elemental (água, ar, fogo,
      terra ou espírito). Você sempre gasta metade dos PMs
      necessários (arredonde para cima) para lançar magias do
      elemento escolhido.
  ...
  {
    Nome: "Energia Extra",
    Descricao: `Você consegue invocar forças interiores para se recuperar
    espantosamente, recarregando seus Pontos de Vida.
    Você pode gastar 2 PMs para recuperar todos os seus
    PVs. Usar a Energia Extra leva um turno inteiro, e você é
    considerado indefeso enquanto se concentra. Se sofrer dano,
    ...
    Morte (veja em "Pontos de Vida"). Por 2 pontos a Energia
    Extra pode ser usada a qualquer momento.
    Energia Extra é parecida com magia de cura, mas
    serve apenas para curar você mesmo, e não funciona contra
    qualquer outro tipo de mal (doenças, veneno...).`,
    Pontos: 2
  },
  {
    Nome: "Energia Vital",
    Descricao: `Você pode usar sua própria energia vital para alimentar
  ...
  {
    Nome: "Familiar",
    Descricao: `Você tem um pequeno animal mágico que partilha suas
    habilidades. Um Familiar é como um Parceiro mais fraco que
    evolui com o conjurador na mesma proporção. Cada ponto
    conquistado é revertido em um ponto que pode ser gasto
    para melhorar seu Familiar. O conjurador e o Familiar também
    possuem uma Ligação Natural (veja adiante).
    Exemplo: um mago com F1, H4, R2, A3, PdF1 e Arena
    une-se a um corvo familiar com F0, H1, R1, A0, PdF0 e Voo.
    Agora a dupla terá F1, H4, R2, A3, PdF1, Arena e Voo (o
    mago também será capaz de voar).
    ...
    para um personagem recém-criado. Em vez disso, um
    Familiar custará 10 Pontos de Experiência, devendo ser
  ...
  },
  {
    ...
    Descricao: `Você pode mudar de forma e poderes. Para cada
    Forma Alternativa que tiver, pode construir um personagem
    diferente com a mesma quantidade de pontos, com outras
    características e vantagens — mas desvantagens, perícias
    e magias conhecidas permanecem sempre as mesmas.
    Digamos que seu personagem de 12 pontos tenha F4,
    H2, R2, A3, PdF1, Ataque Especial (1 pt), Forma Alternativa
    (2 pts), Código de Honra dos Heróis (–1 pt) e Maldição
    (–2 pts); ele pode mudar para uma segunda forma
    com F0, H5, R1, A1, PdF5,
    Aparência Inofensiva (1 pt), Forma
    Alternativa (2 pts), Código e
    Honra dos Heróis (–1 pt) e Maldição
    (–2 pts). Repare que as
    duas formas têm o mesmo
    Código de Honra e Maldição,
    e ambas precisam
    pagar 2 pontos
    por Forma Alternativa.
    (Nota: Monstruoso
    e Modelo
    Especial são as
    únicas desvantagens
    que não precisa ser partilhada
    por todas as Formas.)
    Você pode comprar
    várias Formas
    Alternativas. Cada Forma pode ter uma vantagem única (veja o próximo capítulo),
  ...
  {
    Nome: "Genialidade",
    Descricao: `Você é um gênio. Recebe H+2 ao utilizar qualquer
    perícia que possua, ou em qualquer teste de Habilidade
    envolvendo uma perícia que não possua.
    Com os recursos necessários, a critério do mestre,
    esta vantagem também permite feitos acima do nível técnico
    de seu mundo (como fabricar um motor a vapor em
    mundos medievais, ou consertar uma nave interestelar
    na época atual). Em Arton, por exemplo, é necessário
    ter esta vantagem para lidar com armas de fogo,
    canhões e balões de ar quente.`,
    Pontos: 1
  },
  {
    Nome: "Imortal",
    Descricao: `Por algum motivo,
    você nunca pode morrer. Na
    verdade, você até pode morrer
    — mas nunca vai continuar
    morto. Algum tipo de força
    maior ou energia sobrenatural
    impede sua entrada
    no Reino dos Mortos,
    e você sempre vai retornar
    ao mundo dos
    vivos (com 1 PV e
    1 PM). Isso pode
    acontecer por
    você ser de uma raça imortal, ter recebido uma dádiva (ou maldição) dos deuses,
    ter algum poder regenerativo, ou qualquer coisa assim.
    Por 1 ponto, retornar da morte leva dias, semanas ou
    até meses. Em termos de jogo, caso você seja morto durante
    uma aventura, não poderá retornar antes da aventura seguinte.
    Por 2 pontos, você retorna da morte logo após o
    combate, ou assim que a situação de perigo acaba.
  ...
  {
    Nome: "Inimigo",
    Descricao: `Você é especialmente treinado em combater certo tipo
    ...
    (incluindo máquinas). Você recebe H+2 em combate e
    testes de perícias envolvendo criaturas deste tipo (saiba
    mais sobre essas criaturas no capítulo “Vantagens Únicas”).
    O mestre pode proibir esta vantagem, por exemplo,
    em mundos e campanhas onde só existam humanos (não
    é justo pagar 1 ponto para ter H+2 contra todo mundo), ou
    onde outras criaturas sejam muito raras.`,
    Pontos: 1
  },
  {
    Nome: "Invisibilidade",
    Descricao: `Você pode ficar invisível. Fora de combate, esta habilidade
    ...
    ataques corporais contra você, e H–3 para ataques à distância
    ou esquivar (estes são os mesmos redutores que um
    personagem sofre quando está cego).
    Personagens com Audição Aguçada não sofrem
    redutor em combate corpo-a-corpo, e sofrem apenas H–2 para ataques à distância e esquivas. Ver o Invisível (a magia
    ou Sentidos Especiais) vence totalmente sua invisibilidade.
    Ativar e manter a Invisibilidade custa 1 PM por turno.`,
    Pontos: 2
  },
  {
    Nome: "Invulnerabilidade",
    Descricao: `Você é praticamente imune a certo tipo de dano.
    Quando recebe um ataque baseado nesse dano, após ser
    comparado à sua Força de Defesa, ele será dividido por dez
    (arredonde para baixo). O mesmo vale para dano que não
    venha de ataques (como algumas magias), que ignoram sua
    Armadura, ou qualquer outro. Isso quer dizer que qualquer
    dano inferior a 10 é anulado, e apenas quantidades fantásticas
    desse dano (provavelmente de uma escala superior)
    podem ferir você.
    Os tipos de Invulnerabilidade são os mesmos existentes
    para Armadura Extra. É possível ter Armadura Extra e também
    Invulnerabilidade contra certo tipo de dano. Os efeitos
    se acumulam: o dano é dividido por dez, e sua Armadura
    também é dobrada contra ele.
    Esta vantagem não pode ser comprada com pontos.
    No entanto, ela pode aparecer mais adiante como parte
    de uma vantagem única (por exemplo, um Demônio tem
    Invul ne ra bilidade: Fogo), ou oferecida por um item mágico.`,
    Pontos: 0
  },
  {
    Nome: "Ligação Natural",
    Descricao: `Você tem uma ligação especial com seu Aliado. Os dois
    ...
    os pensamentos um do outro; são capazes de se
    comunicar sem nenhum sinal aparente. Fora do campo de
    visão, vocês podem apenas sentir emoções gerais, mas
    sempre sabem em que direção e distância o outro está.
    Quando você comanda seu Aliado, ele pode usar
    quaisquer vantagens de combate que você tenha. Veja a
    manobra Comandar Aliados no capítulo “Combate”.
    Como efeito colateral dessa ligação poderosa, sempre
    que seu Aliado é ferido, você também sofre dano equivalente.
    É como quando um piloto mecha fica ferido quando seu
    mecha recebe dano. Caso você ou seu Aliado pertençam
    a escalas diferentes, o dano é ajustado de acordo (se um
    Aliado Sugoi recebe 20 pontos de dano, você perde 2 PVs).`,
    Pontos: 1
  },
  {
    Nome: "Magia Branca",
    Descricao: `Você é um conjurador de magia sagrada. Quase todas
    as suas magias são curativas ou defensivas, enquanto
    algumas poucas são ofensivas. Confira mais detalhes no
    capítulo “Magos e Magia”.`,
    Pontos: 2
  },
  {
    Nome: "Magia Elemental",
    Descricao: `Você é um conjurador de magia ligada à natureza e
    aos espíritos, representada pelos quatro elementos: terra,
    água, fogo e ar. Seus efeitos são variados, incluindo magias
    ofensivas do fogo, magias congelantes da água, magias
    defensivas da terra e magias do ar (que permitem formar barreiras de ar, voar ou respirar sob a água). Existe ainda o
    elemen talismo espiritual, que afeta a mente e alma. Confira
    mais detalhes no capítulo “Magos e Magia”.`,
    Pontos: 2
  },
  {
    Nome: "Magia Negra",
    Descricao: `Você é um conjurador de magia negra, invocando o
    poder da necromancia e demonologia. Quase todas as suas
    magias estão ligadas a morte, doença, veneno, deterioração,
    estagnação. Confira mais detalhes no capítulo “Magos e Magia”.`,
    Pontos: 2
  },
  {
    Nome: "Magia Irresistível",
    Descricao: `É mais difícil resistir às suas vantagens e magias. O
    redutor sofrido pela vítima depende do custo:`,
    Pontos: 3,
    Tipo: [
      {
        Nome: "1 ponto",
        Descricao: `a vítima sofre –1 em seu teste de Resistência.`,
        Pontos: 2
      },
      {
        Nome: "2 ponto",
        Descricao: `vítima sofre –2 em seu teste de Resistência.`,
        Pontos: 2
      },
      {
        Nome: "3 ponto",
        Descricao: `a vítima sofre –3 em seu teste de Resistência.`,
        Pontos: 2
      }
    ]
  },
  {
    Nome: "Membros Elásticos",
    Descricao: `Seus braços, pernas ou tentáculos podem ir muito mais
    longe que o normal. Você pode esticá-los, ou então violar
    o espaço-tempo e abrir um “mini portal dimensional” para
    levar seus braços a longas distâncias (o mesmo alcance de
    sua Força, se ela fosse Poder de Fogo). Você não precisa
    de Poder de Fogo para atacar a essa distância; pode atacar
    com socos e chutes.
  ...
  {
    Nome: "Membros Extras",
    Descricao: `Você tem numerosos braços, pernas, cauda ou tentáculos.
    Você pode comprar esta vantagem várias vezes — por
    exemplo, gastando 3 pontos para ter três braços, tentáculos
    ...
    Se não quiser fazer um ataque extra, o personagem
    pode usar seu Membro Extra para bloquear (FD+1 até a
    próxima rodada). Os bônus são cumulativos: bloquear com
    dois Membros Extras oferece FD+2.
  ...
  {
    Nome: "Memória Expandida",
    Descricao: `Você tem uma memória infalível. Pode lembrar tudo
    ...
    mais de uma perícia ao mesmo tempo — para aprender
    uma nova perícia, primeiro é preciso “apagar” a anterior.
  ...
  {
    Nome: "Mentor",
    Descricao: `Você ainda tem contato com a pessoa que ensinou
    você a usar seus poderes, habilidades de combate e magias.
    Pode ser um velho sensei, um guerreiro veterano, um
    clérigo que ensinou você a louvar uma divindade, um mago
    que aceitou você como aprendiz, e assim por diante. Ele é muito
    sábio e sabe responder a praticamente qualquer pergunta.
    Mesmo que o mentor esteja morto ou distante, em momentos
    de dificuldade você pode se lembrar de algum ensinamento
  ...
  {
    Nome: "Paladino",
    Descricao: `Você é um guerreiro sagrado. Um soldado que recebeu
    ...
    Paladinos recebem um bônus de +1 em testes de
    Resistência. Isso não aumenta seus Pontos de Vida ou Magia
    além do normal para sua Resistência verdadeira.
    Um Paladino pode lançar as magias Cura Mágica e
  ...
  {
    Nome: "Paralisia",
    Descricao: `Você tem o poder de paralisar temporariamente o
    ...
    cada PM extra (por exemplo, 6 turnos se você
    gastou 6 PMs). Se a vítima é bem-sucedida em
    seu teste de Resistência, os PMs são perdidos.
  ...
  {
    Nome: "Parceiro",
    Descricao: `Esta vantagem deve ser usada em conjunto com um
    ...
    com seus movimentos. Quando você e seu Parceiro se unem
    para atacar, agem como se fossem um só lutador!
    ...
    Exemplo: um lutador com F1, H4, R3, A1, PdF0 e
    Ataque Especial luta com seu Parceiro que tem F3, H2, R1,
    A2, PdF 2, Arena e Torcida. Pegamos as características mais
    altas, reunimos a vantagens e temos uma dupla com F3, H4,
    R3, A2, PdF 2, Ataque Especial, Arena e Torcida. Quando
    vocês recebem dano, esse dano será dividido igualmente
    entre os dois personagens (arredonde para cima). Seu Aliado também deve possuir esta vantagem.
    Atenção: lutar com um Parceiro é o único caso em
    que você pode derrotar um oponente em desvantagem
    numérica e ainda receber Pontos de Experiência (veja em
    “Experiência”).`,
    Pontos: 1
  },
  {
    Nome: "Patrono",
    Descricao: `Uma grande organização, empresa, governo ou NPC
    poderoso ajuda você. Dentro de certos limites, um Patrono
    pode fornecer transporte, equipamento e informação para
    um empregado. Um Patrono também pode ajudar e enviar
    ...
    ajuda virá depende do mestre — desde uma nova arma
    secreta ou manobra não testada, a um veículo de fuga que
    surge na hora certa. Contudo, em alguns momentos ou
    situações, talvez nenhuma ajuda seja possível. Ter um Patrono também significa que você precisa
    ser leal e seguir ordens. Muitas vezes vai precisar cumprir
    missões para seu Patrono.
    Para conjuradores, esta vantagem fornece três magias
    extras (cumulativo com Clericato e Mentor). Elas são
    escolhidas pelo mestre.`,
    Pontos: 1
  },
  {
    Nome: "Poder Oculto",
    Descricao: `Você é mais poderoso do que parece. Em situações de
    combate e outras emergências (a critério do mestre), pode
    manifestar características superiores.
    Você pode gastar 1 PM para aumentar uma característica
    em +1. Você pode aumentar qualquer número de
    características, até um máximo de +5. Como alternativa,
    seu Poder Oculto pode afetar apenas uma característica,
    escolhida durante a criação do personagem. Neste caso,
    cada PM garante um bônus de +2, até um máximo de +10!
    O Poder Oculto não pode ser ativado ou mantido em
    situações que não envolvem perigo. Isso significa que você
    não pode ativá-lo antes de uma luta. Além disso, ativar o
    Poder Oculto leva tempo: 1 turno para cada aumento de +1.
    Por exemplo, se você quer F+2 e H+3, vai gastar 5 PMs e 5
    turnos. Em combate, apenas um inimigo muito honrado, confiante
    ou estúpido permitirá que você tenha todo esse tempo.
    Você não pode fazer nada enquanto se concentra. Se
    receber qualquer ataque, será considerado indefeso (apenas
    sua Armadura conta em sua Força de Defesa). E se sofrer
  ...
  },
  {
    ...
    Descricao: `Você tem Pontos de Magia adicionais, além daqueles já
    oferecidos por sua Resistência. Esta vantagem é especialmente
    recomendada para conjuradores e outros personagens que
    usam PMs para ativar suas magias ou habilidades especiais. Cada vez que compra esta vantagem, você recebe
    PMs equivalentes a R+2. Então, se você tem R4 (20 PMs)
    e paga um ponto por PMs Extras, agora terá Pontos de Magia
    equivalentes a R6 (ou seja, 30 PMs).
    Esta vantagem não afeta sua Resistência verdadeira e
    nem seus PVs, apenas seus PMs. Então, no exemplo anterior,
    você continuaria com 20 PVs e R4 para testes contra
    magias, velocidade máxima e outras situações. Você pode
    comprar a vantagem várias vezes para ter novos aumentos
    de R+2 em seus PMs.`,
    Pontos: 1
  },
  {
    Nome: "Pontos de Vida Extras",
    Descricao: `Você tem Pontos de Vida adicionais, além daqueles já
    ...
    Esta vantagem não afeta sua Resistência verdadeira
    e nem seus PMs, apenas seus PVs. Então, no exemplo
    anterior, você continuaria com 10 PMs e R2 para efeito de
    testes contra magias, velocidade máxima e outras situações.
    Você pode comprar a vantagem várias vezes para ter novos
    aumentos de R+2 em seus PVs.`,
    Pontos: 1
  },
  {
    Nome: "Possessão",
    Descricao: `Você pode possuir o corpo de outro ser inteligente. Para
    ...
    custo da possessão em PMs (por exemplo, possuir uma vítima com R3 e Resistência a Magia custa 5 PMs). Você
  ...
  {
    Nome: "Reflexão",
    Descricao: `Como Deflexão, mas melhor. Permite não apenas bloquear
    ...
    Se conseguir deter o ataque completamente (sua FD é igual
    ou superior à FA do atacante), além de não sofrer nenhum
    dano, você devolve o ataque para o atacante com a mesma
    FA original.
    A Reflexão é considerada uma esquiva — ou seja, você
    só pode usar um número máximo de vezes por rodada igual
    à sua Habilidade.`,
    Pontos: 2
  },
  {
    Nome: "Regeneração",
    Descricao: `Você é muito difícil de matar. Portador de um poderoso
    ...
    normalmente. No próximo turno, se não receber novos
    ataques (veja em “Castigo Contínuo”), terá recuperado 1
    PV e poderá voltar a agir.
    2-3) Inconsciente: você recupera 1 PV e retorna à
    consciência em um minuto, ou 10 rodadas, ou imediatamente
    com um teste de Medicina +2.
    4-5) Quase Morto: você recupera 1 PV em 8 horas.
    6) Morto: você retorna da morte em alguns dias,
    semanas ou meses, como se fosse um Imortal. Você não
    ...
    rodada. Por exemplo, se você está com 15 PVs, vai sofrer
    colapso total se sofrer 150 pontos de dano na mesma rodada
    (após sua Força de Defesa absorver parte do dano). O dano
    mínimo para colapso total é igual a 10 vezes sua Resistência.
    Regeneração não afeta Pontos de Magia.`,
    Pontos: 3
  },
  {
    Nome: "Resistência à Magia",
    Descricao: `Esta vantagem torna você muito resistente aos efeitos
    de qualquer vantagem ou magia — exceto dano. Sempre que
    uma vantagem ou magia exige um teste de R para ignorar
    seu efeito (como Cegueira, Paralisia, Silêncio e outras),
    você recebe +2 no teste. Um resultado 6 ainda é uma falha.
    Resistência à Magia não funciona contra veneno,
    doenças ou ataques especiais de certas criaturas (como o sopro de um dragão ou o olhar petrificante de uma medusa);
    funciona apenas contra vantagens e magias.
    ...
    Esta vantagem não tem efeito contra dano, a menos
    que esse dano possa ser evitado (ou reduzido) com um teste
    de Resistência. Contra dano mágico, veja Armadura Extra.`,
    Pontos: 1
  },
  {
    Nome: "Riqueza",
    Descricao: `Como Patrono, mas melhor, porque você não precisa
    seguir ordens de ninguém. Dinheiro não é problema para
    você: pode pagar viagens, contratar equipes e comprar
    qualquer equipamento normal, não-mágico.
    Você pode, a qualquer momento, gastar 1 Ponto de
    Magia para invocar sua Riqueza. A forma exata como seu
    dinheiro vai ajudar depende do mestre — desde uma chance
    para subornar um inimigo, até contratar mercenários que
    surgem em um piscar de olhos. Contudo, em alguns momentos
  ...
  },
  {
    ...
    Descricao: `Você tem sentidos muito mais aguçados que os humanos
    ...
    ou muito distantes.
    Faro Aguçado: você tem sensores químicos capazes
    de farejar tão bem quanto um perdigueiro.
    ...
    perceber tudo à sua volta, formas e objetos (mas não cores),
    ...
    Visão de Raio X: você pode ver através de portas
    e paredes, exceto aquelas feitas de chumbo, ou outros
    materiais muito densos ou mágicos.
    Algumas criaturas têm um ou mais Sentidos Especiais
    sem possuir necessariamente a vantagem, nem gastar
    pontos. Por exemplo, um anão tem Infravisão, mas não
    tem quaisquer outros dois sentidos como se tivesse gasto
    1 ponto na vantagem.`,
    Pontos: 2
  },
  {
    Nome: "Separação",
    Descricao: `Em situações de combate você pode gastar PMs e invocar
    ...
    você) sofrem penalidade de –1 em suas características
    (afetando também seus PVs e PMs). Este redutor não é
    cumulativo: duas cópias terão, ambas, –1 em características.
    O número máximo de cópias que você pode criar é
    ...
    cópias), mas NÃO pode criar novas cópias.
    Em aparência, as cópias são exatamente iguais ao
    original: não há como saber quem é quem (caso seja um
    jovem ninja atrapalhado, talvez nem VOCÊ saiba quem é
    quem). Se qualquer de vocês chegar Perto da Morte, a 0
    PVs ou então morrer, todas as cópias desaparecem.`,
    Pontos: 2
  },
  {
    Nome: "Telepatia",
    Descricao: `Esta vantagem tem as seguintes utilizações:
    • Ler pensamentos. Você recebe H+2 em perícias
    para obter informações de outra pessoa (Interrogatório,
    Intimidação, Lábia).
    ...
    • Prever movimentos. Você adivinha os próximos
    passos do adversário, recebendo +1 em sua iniciativa e
    ...
    fazê-lo mais de uma vez por turno. Você só pode tentar ler
    a mente de alguém que consiga ver.
  ...
  {
    Nome: "Teleporte",
    Descricao: `Você é capaz de desaparecer de um lugar e reaparecer
    ...
    não pode levar consigo outras pessoas ou cargas (apenas
    seus pertences pessoais).
    A distância máxima que você pode atingir é igual a
    dez vezes sua Habilidade, em metros. Assim, se você tem
    Habilidade 2, pode se teleportar até 20 metros. Teleporte
    concede +2 em esquivas (não cumulativo com Aceleração).
    Teleportar-se gasta 1 PM e é o mesmo que mover-se.
    Você pode teleportar-se e agir na mesma rodada. Se também
    tiver Aceleração, você pode teleportar-se duas vezes
    na mesma rodada.`,
    Pontos: 2
  },
  {
    Nome: "Tiro Carregável",
    Descricao: `Você tem a capacidade de concentrar energia para um
    ...
    Usar o Tiro Carregável exige 2 PMs e um turno inteiro
    se concentrando. Você é considerado indefeso durante esse
    tempo e, se sofrer dano, perde a concentração (assim como
    os PMs). No turno seguinte faça seu ataque normal, mas
    com PdF dobrado.
    Exemplo: um personagem com H2, PdF4 emprega um
    turno concentrando energia e, no turno seguinte, faz seu
    disparo. Sua Força de Ataque será 2+(4x2), total FA 10.`,
    Pontos: 1
  },
  {
    Nome: "Tiro Múltiplo",
    Descricao: `Você pode fazer mais ataques com PdF em uma única
    ...
    pode fazer por rodada é igual à sua Habilidade. A Força de Ataque de cada golpe conta separadamente
    para vencer a Força de Defesa do inimigo. Você não pode
    somar a FA de seus vários ataques.`,
    Pontos: 2
  },
  {
    Nome: "Toque de Energia",
    Descricao: `Você pode transmitir pela própria pele uma poderosa
    carga de energia, capaz de gerar uma Força de Ataque igual
    à Armadura + 1d para cada PM gasto. Por exemplo, um
    personagem que gasta 3 Pontos de Magia na manobra ataca
    com FA=A+3d. Habilidade não é incluída.
    A carga atinge quaisquer criaturas que estejam à distância
    de combate corpo-a-corpo, mesmo que não estejam
    tocando diretamente o personagem.
    O tipo de energia é escolhido pelo jogador quando
    compra a vantagem, e não pode ser trocado (mas você pode
    ...
    em cada utilização é igual à sua Armadura.`,
    Pontos: 1
  },
  {
    Nome: "Torcida",
    Descricao: `Você tem fãs, e eles inspiram suas lutas! Um grupo
    de admiradores acompanha você e torce por seu sucesso.
    Às vezes esse fã-clube pode ser um verdadeiro estorvo,
    seguindo você por toda a parte, tirando seu sossego e
    impedindo-o de agir furtivamente. Mas, em combates, seus
    torcedores são preciosos.
    Entre outras coisas, o maior benefício de uma Torcida
    é que ela aumenta seu moral. Durante uma luta, quando uma
  ...
  {
    Nome: "Voo",
    Descricao: `Você pode voar. Quanto maior sua Habilidade, melhor
